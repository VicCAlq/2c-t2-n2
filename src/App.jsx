...
export default function App() {
  ...
  const handleSelecionarNoticia = (noticia) => {
    if (noticia && noticia.endereco) {
      window.open(noticia.endereco, '_blank');
    }
  };

  return (
    <div style={{ width: '100%', minHeight: '100vh', background: 'var(--uol-gray-bg)' }}>
      <Header 
      ...
      <main className="portal-container">
        ...
        <TabelaNoticias 
          ...
          aoSelecionarNoticia={handleSelecionarNoticia}
          aoLimparFiltros={handleLimparFiltros}
        />
